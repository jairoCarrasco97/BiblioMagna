...
public class LibroDAO {
    ...
    public boolean insertarLibro(Libro libro) {
        ...
        try (PreparedStatement pstmt = conexion.prepareStatement(sql)) {
            ...
            pstmt.setDate(2, libro.getPublicacion());
    ...
    public List<Libro> listarLibrosAutor(String autor) {
        ...
        // Método para Listar libros según el título
    ...
    public List<Libro> listarLibrosTitulo(String titulo) {
        ...
        try (PreparedStatement pstmt = conexion.prepareStatement(sql)) {
            pstmt.setString(1, "%" + titulo + "%"); // Uso de % para encontrar coincidencias que contengan el texto introducido
